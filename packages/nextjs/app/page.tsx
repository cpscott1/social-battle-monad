...
const BattleIcon: React.FC<IconProps> = ({ className, ...props }) => (
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M17 6L19.5 4L22 6.5L19.5 8.5L17 6ZM7 16L9.5 14L12 16.5L9.5 18.5L7 16ZM17 21.5L19.5 19.5L22 22L19.5 24L17 21.5Z"
      fill="currentColor"
    />
...
const MarketplaceIcon: React.FC<IconProps> = ({ className, ...props }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M3 2C2.44772 2 2 2.44772 2 3V21C2 21.5523 2.44772 22 3 22H21C21.5523 22 22 21.5523 22 21V3C22 2.44772 21.5523 2 21 2H3ZM4 20V4H20V20H4Z"
      fill="currentColor"
    />
    ...
    <main className="min-h-screen">
      <div className="flex items-center flex-col flex-grow pt-10 container mx-auto px-4">
        ...
        <section className="w-full mt-32 px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-[#00E0FF]">Platform Features</h2>
